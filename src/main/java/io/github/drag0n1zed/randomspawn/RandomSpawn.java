package io.github.drag0n1zed.randomspawn;

import io.github.drag0n1zed.randomspawn.config.RandomSpawnConfig;
...
public class RandomSpawn {
    ...
    private static final String NBT_KEY_SPAWN_X = "randomspawn:spawn_x";
    private static final String NBT_KEY_SPAWN_Y = "randomspawn:spawn_y";
    private static final String NBT_KEY_SPAWN_Z = "randomspawn:spawn_z";
            ...
            if (!data.contains(NBT_KEY_SPAWN_X)) {
                ...
                for (int attempt = 0; attempt < MAX_ATTEMPTS; attempt++) {
                    ...
                    if (teleportPos != null) {
                        ...
                        player.sendSystemMessage(Component.translatable("info.randomspawn.system.firstsuccess"));
                ...
                player.sendSystemMessage(Component.translatable("info.randomspawn.system.firstfail"));
            }
        }
    }
        ...
        if (event.getEntity() instanceof ServerPlayer player) {
            ...
            if (!player.isRespawnForced()) {
                ...
                if (data.contains(NBT_KEY_SPAWN_X)) {
                    ...
                    player.sendSystemMessage(Component.translatable("info.randomspawn.system.deathtpsuccess"));
                }
            }
        }
    }
